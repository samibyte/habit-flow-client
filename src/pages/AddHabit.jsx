...
const AddHabit = () => {
  ...
  const colors = [
    { value: "purple", class: "bg-purple-500", name: "Purple Passion" },
    { value: "blue", class: "bg-blue-500", name: "Blue Calm" },
    { value: "green", class: "bg-emerald-500", name: "Green Growth" },
    { value: "orange", class: "bg-orange-500", name: "Orange Energy" },
    { value: "pink", class: "bg-pink-500", name: "Pink Motivation" },
  ];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axiosInstance.post("/api/v1/habits", habitData);
                    ...
                    >
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 bg-base-200 border border-base-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent placeholder-base-content/40 transition-all"
                        />
                      </div>
                    </motion.div>
                  )}
                  ...
                  <div
                    className={`p-4 rounded-xl border-2 ${
                      formData.color === "purple"
                        ? "border-purple-200 bg-purple-150"
                        : formData.color === "blue"
                          ? "border-blue-200 bg-blue-150"
                          : formData.color === "green"
                            ? "border-emerald-200 bg-emerald-150"
                            : formData.color === "orange"
                              ? "border-orange-200 bg-orange-150"
                              : "border-pink-200 bg-pink-150"
                    }`}
                  >
